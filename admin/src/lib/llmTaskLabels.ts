const LLM_TASK_LABELS: Record<string, string> = {
  ...
  keyword_seed_extraction: 'Leistungs-Keywording Seed Extraction',
  keyword_consolidation: 'Leistungs-Keywording Konsolidierung',
  keyword_target_assignment: 'Leistungs-Keywording Zielzuordnung',
  keyword_quality_guard: 'Leistungs-Keywording Qualitätsprüfung',
